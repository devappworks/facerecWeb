...
class CurrentSystemProfile(RecognitionProfile):
    ...
    def get_config(self):
        return {
            ...
            "detection_confidence_threshold": 0.95,  # 95% (lowered from 99.5% → 97%)
...
class ArcFaceSystemProfile(RecognitionProfile):
    ...
    def get_config(self):
        return {
            ...
            # Recognition thresholds
            "recognition_threshold": 0.50,  # ArcFace threshold (needs to be lenient for difficult angles)
            "detection_confidence_threshold": 0.95,  # 95% (lowered from 99.5% → 97%)
            ...
            "normalize_face": True,
            "align": True,
            "batched": True,  # Enabled: ArcFace pickle file now generated successfully
